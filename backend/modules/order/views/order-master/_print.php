...
//                $delivary_charge = 0;
                                ...
                                <table style="width: 100%;padding-bottom: 10px;border-bottom: 2px solid #5a5959;">
                                        ...
                                        if (isset($order_master->promotion_discount) && $order_master->promotion_discount != '') {
                                                $promotion_discount = $order_master->promotion_discount;
                                                ?>
                                                <tr>
                                                        <td style="width:50%"><span style="float: right;font-weight: 600;padding-right: 20px;">Promotion Discount </span></td>
                                                        <td style="width:15%"></td>
                                                        <td style="width:15%"></td>
                                                        <td style="width:20%"><span style="float: right;font-weight: 600;padding-right: 20px;"><?= sprintf('%0.2f', $order_master->promotion_discount); ?></span></td>
                                                </tr>
                                        <?php } ?>
                                        <tr>
                                ...
                                <?php $grand_total = $amount_total + $delivary_charge - $promotion_discount; ?>
