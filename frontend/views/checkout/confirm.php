                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="">
                                                ...
                                                if (isset($order_master->promotion_discount) && $order_master->promotion_discount != '') {
                                                        $promotion_disvount = $order_master->promotion_discount;
                                                        ?>

                                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 shipping">
                                                                <h5 class="product-heading text-right">Promotion Discount:</h5>
                                                        </div>

                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 shipping-cost">
                                                                <p class="text-right price"> <?= sprintf('%0.2f', $order_master->promotion_discount) ?></p>
                                                        </div>
                                                <?php } ?>
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 total-cost">
                                                        <?php $grand_total = $subtotal + $ship_charge - $promotion_disvount ?>
