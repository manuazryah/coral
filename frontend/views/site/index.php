							...
							<div class="col-xs-12 col-sm-6 col-md-3 gp_products_item">
								<div class="gp_products_inner">
									<div class="gp_products_item_image">
										...
										<?= Html::a(' <div class="img-overlay"></div>', ['/product/product_detail', 'product' => $featured_product->canonical_name], ['class' => '']) ?>
									...
									<div class="gp_products_item_caption">
										...
										<ul class="gp_products_caption_name">
											<li><a href="<?= Yii::$app->homeUrl . 'product_detail/' . $featured_product->canonical_name ?>" title="<?= $featured_product->product_name ?>"><?= substr($featured_product->product_name, 0, 40) ?></a></li>
							...
							?>">
								<div class="col-xs-12 col-sm-6 col-md-3 gp_products_item">
									<div class="gp_products_inner">
										...
										<div class="gp_products_item_caption">
											<ul class="gp_products_caption_name">
												<li><a href="<?= Yii::$app->homeUrl . 'product_detail/' . $international->canonical_name ?>" title="<?= $international->product_name ?>"><?= substr($international->product_name, 0, 40) ?></a></li>
											...
											<ul class="gp_products_caption_rating">
												<?php
												if ($international->offer_price != "0" && $international->offer_price != '') {
