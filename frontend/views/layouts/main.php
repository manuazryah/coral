	...
	<body>
		...
		<div id="sticky-header">
			...
			<div id="header">
				<div class="container">
					<div class="row">
						<?= Html::beginForm(['/product/search'], 'get', ['id' => 'serach-formm']) ?>
								...
								<div class="container">
									...
									<ul class="navbar-right hidden-sm hidden-xs">
										<?php if (Yii::$app->user->isGuest) { ?>
											...
											echo '<li>' . Html::beginForm(['/site/logout'], 'post') . Html::submitButton('Logout (' . $name . ')', ['style' => 'background: white;border: none;']) . Html::endForm() . '</li>';
										}
										?>
