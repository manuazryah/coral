        ...
        $('.quantity').on('change keyup', function () {
                ...
                if (quantity != '' && parseInt(quantity) > '0') {
                        if (parseInt(quantity) <= parseInt(max)) {
                                ...
                                var total = (parseInt(price) * parseInt(max));
                                updatecart(id, max, total);
                        }
                } else if (quantity != '') {
                        $('#quantity_' + id).val('1');
                }
        ...
        $(".gender-select").click(function () {
                ...
                $.ajax({
                        ...
                        success: function (data) {
                                if (featured === "" && keyword === "") {
                                        if (data == 1) {
                                                window.location = homeUrl + 'product/index?id=' + pro_cat + '&type=' + type + '&category=' + main_categ;
                                        } else if (data == 0) {
                                                window.location = homeUrl + 'product/index?id=' + pro_cat + '&category=' + main_categ;
                                        }
                                } else if (keyword && keyword != '') {
                                        if (data == 1) {
                                                window.location = homeUrl + 'product/index?id=' + pro_cat + '&type=' + type + '&category=' + main_categ + '&featured=' + featured + '&keyword=' + keyword;
                                        } else if (data == 0) {
                                                window.location = homeUrl + 'product/index?id=' + pro_cat + '&category=' + main_categ + '&featured=' + featured + '&keyword=' + keyword;
                                        }

                                } else {
                                        if (data == 1) {
                                                window.location = homeUrl + 'product/index?id=' + pro_cat + '&type=' + type + '&category=' + main_categ + '&featured=' + featured;
                                        } else if (data == 0) {
                                                window.location = homeUrl + 'product/index?id=' + pro_cat + '&category=' + main_categ + '&featured=' + featured;
                                        }
                                }
                        }
                });
