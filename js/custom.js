        ...
        $.ajax({
            ...
            success: function (data) {
                if (featured !== "") {
                    ...
                    if (data == 1) {
                        window.location = homeUrl + 'product/index?id=' + pro_cat + '&type=' + type + '&category=' + main_categ + '&keyword=' + keyword;
                    } else if (data == 0) {
                        window.location = homeUrl + 'product/index?id=' + pro_cat + '&category=' + main_categ + '&keyword=' + keyword;
                    }
