                            ...
                            <div class="header" style="padding-bottom: 0px;">
                                ...
                                <div class="navigation-bar"style="text-align: center;">
                                    <ul style="text-align: center;width: 100%;padding: 5px 0px;margin: 0;list-style-type: none;background-color: #93c622;">
                                        <li style="display: inline;"><a target="_blank" style="width: 6em;text-decoration: none;color: white;padding: 0.2em 0.6em;border-right: 1px solid white;" href="http://<?= Yii::$app->request->serverName ?>/coral/about-coral-perfumes">ABOUT US</a></li>
                                        <li style="display: inline;"><a target="_blank" style="width: 6em;text-decoration: none;color: white;padding: 0.2em 0.6em;border-right: 1px solid white;" href="#">OUR PRODUCTS</a></li>
                                        <li style="display: inline;"><a target="_blank" style="width: 6em;text-decoration: none;color: white;padding: 0.2em 0.6em;border-right: 1px solid white;" href="http://<?= Yii::$app->request->serverName ?>/coral/coral-perfumes-showrooms">SHOWROOMS</a></li>
                                        <li style="display: inline;"><a target="_blank" style="width: 6em;text-decoration: none;color: white;padding: 0.2em 0.6em;" href="http://<?= Yii::$app->request->serverName ?>/coral/coral-perfumes-contact">CONTACT US</a></li>
                                    </ul>
                                </div>
                            </div>
                        </th>
